    ...
    <main className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      <div className="flex min-h-screen">
                ...
                <div className="flex h-16 items-center justify-between px-4 sm:px-5">
                    ...
                    <div className="flex min-w-0 items-center gap-3">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="truncate text-s, font-bold text-slate-900 dark:text-white">
                                IT Support
                            </p>

                            <p className="truncate text-xs text-slate-500 dark:text-stale-400">
                                Ansattportal
                            </p>
                    ...
                    <div className="flex shring-0 items-center gap-1.5 sm:gap-2">
                        ...
                        <button
                            ...
                            aria-label="Logg ut"
                            title="Logg ut"
                            className="inline-flex h-10 items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate50 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60 dark:border-slate-700 dark:text-slate-200 dark:hober:bg-slate-800"
                        >
                            <svg
                                viewBox="0 0 24 24"
                                fill="none"
                            ...
                            >
                                <path
                                    ...
                                    d="M15 3h4a2 2 00 1 2 2v14a2 2 0 0 1-2 2h-4"
                                />
                        ...
                        <button
                            type="button"
                            arial-label={mobileMenuOpen ? "Lukk meny" : "Åpne meny"}
                            aria-expanded={mobileMenuOpen}
                            onClick={() =>
                                setMobileMenuOpen((open) => !open)
                            }
                            className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 shadow-sm transition hover:bg-slate-50 active:scale-[0.97] dark:border-slate700 dark:bg-slate-900 dark:text-slate200 dark:hover:bg-slate-800"
                        >
                            {mobileMenuOpen ? (
                                <svg
                                    viewBox="0 0 24 24"
                ...
                <div className="p-4">
                    ...
                    <div>
                        ...
                        <div className="space-y-1">
                            ...
                            <button
                                type="button"
                                onClick={() => navigateMobile("/employee")}
                            ...
                            <button
                                type="button"
                                onClick={() => navigateMobile("/employee/tasks")}
                                className="flex min-h-11 w-full cursor-pointer items-center rounded-xl px-3 py-2.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 dark:text-slate-300 dark:hover:bg-slate-900"
                            >
                                Mine tildelte saker
                            </button>
                            ...
                            <button
                                type="button"
                                onClick={() => navigateMobile("/completed-tasks")}
                                className="flex min-h-11 w-full cursor-pointer items-center rounded-xl px-3 py-2.5 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 dark:text-slate-300 dark:hover:bg-slate-900"
                            >
                                Fullførte saker
                            </button>
        ...
        <section className="min-w-0 w-full flex-1 pt-16 lg:ml-64 lg:w-[calc(100%-16rem)] lg:pt-0">
          ...
          <header className="hidden border-b border-slate-200 bg-white px-6 py-6 dark:border-slate-800 dark:bg-slate-900 lg:block lg:px-8">
